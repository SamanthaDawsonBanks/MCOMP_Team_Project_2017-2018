...
/**
 * This class handles the Path object returned from the pathfinding algorithm. The methods in this
 * class act on the current path and retrieve data associated with the Path object, or a new
 * instance of it (optimised version).
 * 
...
public class PathOptimisation {
   ...
   * 
   * @param ArrayList<ScoredVertex> the arrayList to be iterated through. The arrayList is passed in
   *        a copy of the returned Path object.
   * 
  ...
  /**
   * Method is used to reduce the total length of the Path item. With the use of RMI, sending large
   * amount data is inefficient and slow.
   * 
   * @param ArrayList<ScoredVertex> the arrayList to be iterated through. The arrayList is passed in
   *        a copy of the returned Path object.
   * 
