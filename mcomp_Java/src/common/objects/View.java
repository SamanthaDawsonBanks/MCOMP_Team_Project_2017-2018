...
public class View extends Application implements RemoteView {
  ...
  public VBox getVBoxMap() {
    ...
    vboxMap.setStyle("-fx-background-color:#ffffff;"+"-fx-border-width: 4px 4px 4px 4px;"+"-fx-border-color: #000000;");
    ...
    spinner.setStyle("-fx-body-color:#00bfff;" + "-fx-font-size: 10px; " + "-fx-font-weight: bold;");
    ...
    lidarBtn.setOnAction(event -> {
      if (lidarBtn.isSelected()) {
        ...
        pane.getChildren().add(drawLidarLayer(localHerdData.getMap().getLayer(spinner.getValue()).getWaypoints()));
      } else {
        toggleOffStyle(lidarBtn);
  ...
  public VBox getVBoxPath() {
    ...
    vboxPath.setStyle("-fx-background-color:#ffffff;"+"-fx-border-width: 4px 4px 4px 4px;"+"-fx-border-color: #000000;");
    ...
    optimisedPathBtn.setOnAction(event -> {
      if (optimisedPathBtn.isSelected()) {
        ...
        pane.getChildren().add(drawOptimisedPath((localHerdData.getOptimizedPath())));
  ...
  public VBox getMembers() {
    ...
    vboxMember.setStyle("-fx-background-color:#ffffff;"+"-fx-border-width: 4px 4px 4px 4px;"+"-fx-border-color: #000000;");
  ...
  public VBox startButton() {
    ...
    vbox.setStyle("-fx-background-color:#ffffff;"+"-fx-border-width: 4px 4px 4px 4px;"+"-fx-border-color: #000000;");
    vbox.setSpacing(4);
  ...
  public Node toggleOffStyle(Node o) {
    if (o.equals(label)) {
      o.setStyle(
          "-fx-background-color:#00bfff;" + "-fx-border-color: #000000;" + "-fx-border-width: 0px 0px 4px 0px;"
              + "-fx-font-size: 25px; " + "-fx-font-weight: bold;" + "-fx-alignment:center");
      return o;
    } 
    else if(o.equals(killButton) || o.equals(killButton2) || o.equals(killButton3) || o.equals(killButton4)) {
