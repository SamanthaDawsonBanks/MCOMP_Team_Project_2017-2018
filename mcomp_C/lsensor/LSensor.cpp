...
unsigned int LSensor::getAvgRPM() {
  ...
  for (int i = 0; i < 90; i++) {
    ...
    res = res | lowerB;  //res (0) bitwise OR with b2 = b2 but in a 16 bit in not 8 bit byte
    res <<= 8;                       //shift bits 8 left to make space for b3
    res = res | upperB;  //rpmLe (b2+8 zeros) logical OR with b3 = b2 concat b3 in one 16 bit value
...
Waypoint* LSensor::lSensorTest() {
  ...
  byte dummy[1980] = { ,
